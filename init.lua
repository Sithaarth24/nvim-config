...
vim.keymap.set('n', '<leader>nc', function()
  require('neo-tree.command').execute { action = 'collapse_all_nodes' }
end, { desc = 'Collapse all Neo-tree folders' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      ensure_installed = { 'bash', 'rust', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
