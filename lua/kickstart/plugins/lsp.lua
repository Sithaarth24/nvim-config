--- WARNING: long ass config comin up
      ...
      config = function()
        ...
        vim.api.nvim_create_autocmd('LspAttach', {
          ...
          callback = function(event)
            ...
            map('<leader>ln', vim.lsp.buf.rename, '[L]sp [R]e[n]ame')
            ...
            map('<leader>lsd', require('telescope.builtin').lsp_document_symbols, '[L]sp [S]earch [D]ocument')

            -- Fuzzy find all the symbols in your current workspace.
            --  Similar to document symbols, except searches over your entire project.
            map('<leader>lsw', require('telescope.builtin').lsp_dynamic_workspace_symbols, '[L]sp [S]earch [W]orkspace')
